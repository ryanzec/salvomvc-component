 ...
 */
namespace Barrage\Console\Command\ActiveRecord\Relational;
...
use Barrage\DataSource\Relational\DataSourceFactory;
            ...
            foreach($tables as $table)
            {
                if(isset($tableConfiguration[$table]))
                {
                    ...
                    if(!empty($class))
                    {
                        ...
                        {
                            $phpCode = \Barrage\Utility\ModelBuilder::updateModelClass($filePath, $database, $table, $class, $namespace);
                        }
                        else
                        {
                            $phpCode = \Barrage\Utility\ModelBuilder::buildModelClass($database, $table, $class, $namespace);
                        }
