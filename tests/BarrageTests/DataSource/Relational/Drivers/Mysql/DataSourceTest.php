<?php
namespace BarrageTests\DataSource\Relational\Drivers\Mysql;
...
use Barrage\DataSource\Relational\Exception\ConnectionException;
use Barrage\Configuration;

/**
 * @todo: write unit test that test each case where an exception should be thrown
 */
